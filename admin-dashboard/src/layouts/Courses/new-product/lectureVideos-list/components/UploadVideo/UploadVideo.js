...
function UploadVideo({ lectureID, loading }) {
  ...
  return (
    <>
      ...
      <ArgonButton onClick={handleModalOpen} variant="gradient" color="info" size="small">
      Upload Video
                </ArgonButton>
...
UploadVideo.propTypes = {
  lectureID: PropTypes.number, // 'lecture' should be an object (can also specify its shape if needed)
