...
export const fetchCourses = createAsyncThunk(
  ...
  async ({ searchCoursesId, type } = {}) => { // <-- Set default empty object
    const url = searchCoursesId && type
      ? `/course/getall-course?${type}Id=${searchCoursesId}`
      : `/course/getall-courses`; // <-- Fixed the default URL
