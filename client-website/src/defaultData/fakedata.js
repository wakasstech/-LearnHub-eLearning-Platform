...
import articleIcon from "../assests/icons/play-icon.png";
import certificateIcon from "../assests/icons/play-icon.png";
import cardImg from "../assests/images/homeBanner.jpg";
import cardImg2 from "../assests/images/homeBanner.jpg";
import cardImg3 from "../assests/images/homeBanner.jpg";
import showcaseImg from "../assests/images/homeBanner.jpg";
import showcaseImg2 from "../assests/images/homeBanner.jpg";
import showcaseImg3 from "../assests/images/homeBanner.jpg";
import bannerImg1 from "../assests/images/homeBanner.jpg";
import bannerImg2 from "../assests/images/homeBanner.jpg";
import bannerImg3 from "../assests/images/homeBanner.jpg";
import teachIcon from "../assests/icons/play-icon.png";
import askIcon from "../assests/icons/play-icon.png";
import groupUsersIcon from "../assests/icons/play-icon.png";

const Learnings = {
  ttl: "What you'll learn",
  points: [
    "Dars Quran",
    "Recitation of the Quran with proper Tajweed",
    "Gain a foundational understanding of Quranic recitation principles.",
    "Memorization techniques",
    "Historical context of revelations",
    "Application in daily life",
    "Insights into Prophets' lives"
...
const courseReq = {
  ttl: "Requirements",
  reqs: [
    "Basic knowledge of Arabic (optional)",
    "Willingness to learn",
    "Loyalty",
    "Recite Quranic verses with fluency and confidence."
    
  ],
};

const desc = `Have you ever dreamt of reciting the Quran beautifully and accurately? This beginner-friendly course is your perfect guide! Through engaging video lessons, interactive quizzes, and downloadable resources, you'll embark on a comprehensive journey into the fundamentals of Quran recitation with Tajweed. Your instructor, [Instructor Name], a certified Quran teacher with over 10 years of experience, will provide clear explanations and practical guidance to help you master the essential rules of Tajweed. By the end of this course, you'll be equipped with the necessary skills to confidently recite Quran with proper pronunciation, enriching your connection with the holy text.

Enroll today and begin your rewarding journey of learning the Quran!"`;
...
const instructorData = [
  {
    ...
    img: "",
    name: "Teacher",
    desc: "Highly qualified and experienced instructors",
    courses: 23,
    reviews: '12k',
    rating: 5,
    students: 200,
    date: "2024",
    cmmt: "Dedicated to Quranic education. Personalized attention and support Variety of teaching methods. Focus on deeper understanding and appreciation of the Quran",
  },
];
